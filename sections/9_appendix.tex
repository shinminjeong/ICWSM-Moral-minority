...
\textbf{[TODO:]} current template; validation pending. Confirm the final prompt
version after validation and ensure that the template reproduced here matches
the version used for the reported annotations.
